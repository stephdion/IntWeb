<?php include('../../header.php'); ?>
	...
	<section class="container">
		...
		<ul class="nav nav-wizard">
			...
			<li class="active"><a href="#"><i>4</i><span>Dépôt direct</span></a></li>
		...
		<div class="strong">
			<div class="mcl2">
				...
				<div class="form-cont sp-xl">
							...
							<div class="text">
								...
								<label class="radiobutton">
								   <div class="radiobuttons">
										...
										<div class="note hide os-1 os-1-2 sp-s">
											<p><strong>Note:</strong>Si vous êtes déjà inscrit au dépôt direct d'un autre ministère ou organisme, la CNESST ne détient pas vos informations bancaires.</p>
										</div>
					...
					<div class="btns">
						<a class="btn btn7" href="3-situation-familiale.html">Précédent</a>
